...
2.  **API Layer**: Two specialized modules (`gmail-api.js` and `openrouter-api.js`) handle external communications.
...
## 🤖 Step 2: AI Analysis (`openrouter-api.js`)

This module transforms raw email text into structured data using **OpenRouter's AI models**.
...
- **OpenRouter**: Unified API gateway providing access to multiple AI models including Gemini 2.0 Flash.
